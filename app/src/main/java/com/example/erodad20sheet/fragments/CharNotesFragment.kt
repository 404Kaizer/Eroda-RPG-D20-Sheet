...
class CharNotesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val note1  = NotesDataClass("Ellena", "Encontrar Ellena Hart.")
        val note2  = NotesDataClass("Pérola Negra", "Encontrar navio perdido.")
        val note3  = NotesDataClass("Esmeralda", "Recuperar esmeralda roubada.")
        val note4  = NotesDataClass("Taverna Bode Resfriado", "Encontrar Perry Lenin na taverna Bode Resfriado.")
        val note5  = NotesDataClass("Jerry Klint", "Encontrar e matar Jerry Klint na cidade de Pallet.")
        val note6  = NotesDataClass("Chave da Casa Abandonada", "A chave se encontra enterrada no cemitério de Pallet.")
        val note7  = NotesDataClass("Guarda Corrupta", "O chefe da guarda é corrupto e ajuda a mafia da cidade.")
        val note8  = NotesDataClass("Vaso Quebrado", "Deixamos cair um vaso enquanto invadiamos a casa de Lillian. Vai dar merda.")
        val note9  = NotesDataClass("Invasão a Cidadela", "Temos que invadir a cidadela para resgatar Ronny, nosso aliado.")
        val note10 = NotesDataClass("Arrombar Portão", "O portão está trancado e não se sabe onde está a chave. Provavelmente vamos arrombar.")
